      ...
      >
        ...
        <div className="space-y-2.5 relative z-10 max-w-3xl">
          ...
          <p className="text-sm text-blue-100/90 leading-relaxed">
            Real-time management for garment inventory, Kenyan tax invoicing, RFQ customer inquiries, and M-Pesa Paybill / Till reconciliation.
          </p>
        </div>
                ...
                {documents.length === 0 ? (
                  <tr>
                    <td colSpan={6} className="py-8 text-center text-slate-400 text-xs">
                      No invoices or billing documents created yet. Click "+ New Document" above to get started.
                    </td>
                  </tr>
                ) : (
      ...
      >
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                Track garment supplies, finished uniforms, raw fabrics, and reorder levels.
              </p>
            </div>
          </div>
          <motion.button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {lowStockItems.map((item) => (
              <motion.div
                ...
                className="p-3.5 bg-amber-50/70 hover:bg-amber-100/60 rounded-xl border border-amber-200 text-xs flex justify-between items-center transition-all duration-200 cursor-default"
              >
        ...
        <div className="pt-1 flex justify-end">
          <motion.button
            ...
            className="w-full sm:w-auto px-5 py-2.5 bg-slate-50 hover:bg-slate-100 text-[#06163c] font-bold text-xs rounded-xl border border-slate-200 text-center transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-xs hover:shadow-sm"
          >
        ...
        <div className="flex items-center justify-between pb-2 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                Authorized administrators, role permissions, and active team members.
              </p>
            </div>
          </div>
          <motion.button
            ...
            className="text-xs text-blue-600 hover:text-blue-700 font-bold inline-flex items-center gap-1 cursor-pointer group"
          >
            <span>Manage All Staff ({adminUsers.length})</span>
            <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" />
          </motion.button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {adminUsers.map((user) => (
            <div
              key={user.id}
              onClick={() => onNavigateTab('users')}
              className="p-3 bg-slate-50 hover:bg-blue-50/50 rounded-xl border border-slate-200 hover:border-blue-200 flex items-center justify-between gap-3 transition-colors cursor-pointer group"
            >
