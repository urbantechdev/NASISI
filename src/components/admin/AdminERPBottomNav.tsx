  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md z-30 select-none border-t border-slate-200/60 shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.1)]"
      >
