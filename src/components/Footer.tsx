          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-wrap justify-center sm:justify-end">
            ...
            {onOpenAdminERP && (
              <button
                ...
                className="p-2 rounded-lg text-slate-500 hover:text-[#06163c] hover:bg-white active:scale-95 transition-all border border-slate-200/80 hover:border-slate-300 inline-flex items-center justify-center cursor-pointer shadow-2xs group"
                title="Staff & Admin Portal"
                aria-label="Staff & Admin Portal"
              >
                <Lock className="w-4 h-4 text-slate-500 group-hover:text-[#06163c] transition-colors" />
              </button>
            )}
            <button
              onClick={scrollToTop}
